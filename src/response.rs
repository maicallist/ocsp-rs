...
impl BasicResponse {
    ...
    pub async fn to_der(&self) -> Result<Vec<u8>> {
        ...
        v.extend(self.signature_algo.to_der().await?);
...
#[cfg(test)]
mod test {
    use crate::oid::{ALGO_SHA1_NUM, ALGO_SHA1_WITH_RSA_ENCRYPTION_NUM};
    ...
    async fn basic_resp_to_der() {
        ...
        let c = vec![
            0x30, 0x82, 0x02, 0x9, 0x30, 0x81, 0xf2, 0xa2, 0x16, 0x04, 0x14, 0x36, 0x6f, 0x35,
