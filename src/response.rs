...
impl BasicResponse {
    /// return new response data
    pub async fn new(data: ResponseData, algo: Oid, sign: Vec<u8>, cert: Option<Vec<u8>>) -> Self {
        BasicResponse {
            tbs_resp_data: data,
            signature_algo: algo,
            signature: sign,
...
mod test {
    ...
    async fn ocsp_resp_success_to_der() {
        ...
        let oid = Oid::new_from_dot(ALGO_SHA1_WITH_RSA_ENCRYPTION_DOT)
            ...
            .unwrap();
        let sign = vec![
            ,
        ];
