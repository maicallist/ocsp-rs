...
///```
/// see [OcspAsn1Der][ocsp_rs::asn1_common::OcspAsn1Der]
///
#[allow(dead_code)]
...
impl<'d> OcspAsn1Der<'d> {
    ...
    fn extract_certid_raw(&self, tag: &mut Vec<u8>, value: &mut Vec<Vec<u8>>) -> Result<u8, OcspError> {
        // push tag sequence
        ...
        for i in 0..self.seq.len() {
            ...
            match tmp.tag() {
                0x30 => {
                    ...
                    match OcspAsn1Der::extract_certid_raw(&OcspAsn1Der { seq }, tag, value)? {
                        0 => break,
                        1 => continue,
...
1cfc8fa3f5e15ed760707bc46670559b";
        ...
        let mut tag = Vec::new();
        let mut val = Vec::new();
        let _ = der.extract_certid_raw(&mut tag, &mut val);
...
1cfc8fa3f5e15ed760707bc46670559b";
        ...
        let _ = asn1.extract_certid_raw(&mut tag, &mut val);
        //println!(
        //    "-----tag-----\n{:02X?}\n{:02X?}\n------end of line -----",
        //    tag, val
        //);
    ...
    fn ocsp_req_multiple_certid_raw() {
...
041204101cfc8fa3f5e15ed760707bc46670559b";
    ...
    fn ocsp_req_extract_second_certid_raw() {
